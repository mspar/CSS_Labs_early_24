...
```{r}
data <- og_data |> select(sex,age,stateicp,met2013,birthyr,bpld,citizen,yrimmig,yrsusa1,rachsing,educd,degfield,degfieldd,empstat,occ,uhrswork,inctot,migplac1)
