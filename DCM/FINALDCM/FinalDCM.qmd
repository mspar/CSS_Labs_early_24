...
data_mult |> select(sex, age, citizen, rachsing, degfield, degfield_collapsed, empstat, uhrswork, inctot, incearn, poverty, young_migrant) |> 
...
multi <- multinom(degfield ~ sex + age + young_migrant, data = data_mult, trace = F, model = T, na.action = na.exclude)
tidy(multi) |> View()
