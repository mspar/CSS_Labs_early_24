...
> Table 2 shows the results of three logistic probability models. Each model contains the full sample of 1693 observations and presents the coefficients as odds ratios with corresponding confidence intervals in square brackets. Model 1 only uses Happiness as
...
# manually enter linebreaks in title yay
```
...
data_fit <- as.data.frame(tribble(
  ...
  " ", as.character(round(lr_mod12[2,5],5)), as.character(round(lr_mod23[2,5],12))))
